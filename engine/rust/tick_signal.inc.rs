// tick_signal.inc.rs — Internal signal pipeline methods for RustTickProcessor
//
// Included by tick_processor.rs via include!() macro.
// Contains: ensure_symbol, refresh_derived, predict_ensemble, apply_signal_pipeline, predict_short
...
impl RustTickProcessor {
    ...
    fn apply_signal_pipeline(
        ...
        use crate::decision::inference_bridge::zscore_from_buf;
