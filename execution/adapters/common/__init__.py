"""execution.adapters.common — Shared adapter utilities.

Venue-agnostic helpers used by all adapter implementations:
  decimals      safe_decimal, require_decimal, round_down
  hashing       payload_digest, stable_hash, fill_key, order_key
  idempotency   make_fill_idem_key, make_order_idem_key
  schema_checks require_keys, require_non_empty, safe_get, SchemaError
  symbols       normalize_symbol, normalize_side, normalize_order_type, normalize_tif
  time          now_ms, now_utc, ms_to_datetime, coerce_ts_ms
"""
