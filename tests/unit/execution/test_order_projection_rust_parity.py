...
def test_project_order_matches_rust_order_state_machine_terminal_state() -> None:
    events = [
        ...
        {"order_id": "ord-1", "status": "partially_filled", "qty": "1.0", "filled_qty": "0.4", "avg_price": "42000", "ts_ms": 1100},
        {"order_id": "ord-1", "status": "filled", "qty": "1.0", "filled_qty": "1.0", "avg_price": "42100", "ts_ms": 1200},
    ]
