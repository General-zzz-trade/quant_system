...
def build_inference_bridge(
    ...
    *,
    ...
    bridge = LiveInferenceBridge(
        ...
        trend_follow=getattr(runner_cfg, "trend_follow", False),
        trend_indicator=getattr(runner_cfg, "trend_indicator", "tf4h_close_vs_ma20"),
        trend_threshold=getattr(runner_cfg, "trend_threshold", 0.0),
