...
// ============================================================
// RustRiskEvaluator — Unified hot-path risk rule evaluator
// ============================================================
// Evaluates all hot-path rules (max_position, leverage_cap,
// max_drawdown, gross_exposure, net_exposure, concentration)
// in a single Rust call with flat numeric inputs.
//
// Python wrappers handle meta-dict extraction and RiskDecision
// object construction.
