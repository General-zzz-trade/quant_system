...
Usage:
    python3 -m scripts.data.download_onchain                          # BTC + ETH, incremental
    python3 -m scripts.data.download_onchain --asset btc              # BTC only
    python3 -m scripts.data.download_onchain --asset eth --start 2023-01-01
    python3 -m scripts.data.download_onchain --full-refresh           # Re-download all history
    python3 -m scripts.data.download_onchain --dry-run                # Show what would be fetched
"""
